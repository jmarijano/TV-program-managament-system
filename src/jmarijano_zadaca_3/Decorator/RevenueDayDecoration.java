 ...
 * @author morbi_000
 */
public class RevenueDayDecoration extends DayDecoration {

    public RevenueDayDecoration(PlanComponent planComponent) {
        super(planComponent);
    }
    ...
    public void showData() {
        ...
        System.out.format("|%11s|%-40s|%-20s|%-20s|%-20s|%33s|\n",
                ...
                StringHelper.getCenteredString("Maksimalni broj minuta za reklame",33));
